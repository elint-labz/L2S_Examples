        ...
        if (buttonPressed[2] || buttonPressed[1] || buttonPressed[0]) {
         ...
         display.clearDisplay();
          ...
          if (page == 0) {
            ...
            display.println("   ELINTLABZ      ");
            display.drawBitmap(70,35,logo_el,10,10,BLACK);

          } else if (page == 1) {
             display.println(" WRITTEN IN C USING ARDUINO      IDE");
           sizex = 10*6;
           display.setCursor((display.width()-sizex)/2,32);
            display.print("               AUG, 2017");
          } else {
            gamestate = GAME_TITLE;
          } 
